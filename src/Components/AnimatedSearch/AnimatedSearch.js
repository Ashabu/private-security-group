...
const AnimatedSearch = (props) => {
    ...
    const texts = [
        ...
        'როგორ ასრულებს დაკისრებულ მოვალეობას ჩემ მიერ დაქირავებული მოსამსახურე?',
        'სად იმყოფება ჩემი ინტერესის ობიექტი? რა არის მისი საკონტაქტო და სხვა სახის მონაცემები?',
